...
public class GameQuestionFragment extends AbstractFragment implements View.OnClickListener {
    ...
    public int getLayout() {
        return R.layout.fragment_game_question;
    }
    ...
    public void onAttach(Context context) {
        ...
        try {
            ...
            Log.e("GameQuestionFragment", "ClassCastException", ex);
        }
    }
